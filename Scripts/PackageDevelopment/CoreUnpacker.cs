...
namespace TwistCore
{
    public static class CoreUnpacker
    {
        ...
        public static IEnumerator<TaskProgress> UnpackIntoPackageFolderCoroutine(string packageName, string packageToUnpack, string outputDirectoryName)
        {
            // task steps:
        ...
        public static IEnumerator<TaskProgress> RemoveUnpacked(string packageName, string unpackedPackage, string outputDirectoryName)
        {
            // task steps:
            // 0 - remove dir
